...
<body>
    ...
    <main>
        ...
        <article>
            <a href="../back/new_book.php"><box-icon type='solid' name='plus-circle'><svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 24 24" style="fill: rgba(160, 159, 159, 1);transform: ;msFilter:;">
